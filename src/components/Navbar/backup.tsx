...
import type MenuButtonDTO from '../../DTOs/MenuButtonDTO.js';
import type SubmenuDTO from '../../DTOs/SubmenuDTO.js';
import SubmenuContainer from './SubmenuContainer/index.js';
